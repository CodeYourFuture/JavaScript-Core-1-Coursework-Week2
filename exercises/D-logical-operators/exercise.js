...
/* 
  ...
  --------------------------- */
console.log("Is Html knowledge above 5?", htmlLevelAbove5(10));
console.log("Is CSS knowledge above 5?", cssLevelAbove5(4));
console.log("Is Html And CSS knowledge above 5?", cssAndHtmlAbove5(5));
console.log("Is either Html or CSS knowledge above 5?", cssOrHtmlAbove5(8));