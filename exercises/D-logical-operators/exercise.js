...
console.log("Is Html knowledge above 5?");
let cssLevelAbove5 = cssLevel > 5;
console.log("Is CSS knowledge above 5?");
...
console.log("Is Html And CSS knowledge above 5?");
...
console.log("Is Html knowledge above 5?", htmlLevel > 5);
console.log("Is CSS knowledge above 5?", cssLevel > 5);
console.log("Is Html And CSS knowledge above 5?", htmlLevel && cssLevel > 5);
console.log("Is either Html or CSS knowledge above 5?", (htmlLevel > 5) || (cssLevel > 5));
