...
// console.log(calculateGrade(60)); // logs C
// console.log(calculateGrade(80)); // logs A
// console.log(calculateGrade(70)); // logs B
// console.log(calculateGrade(50)); // logs C
// console.log(calculateGrade(49)); // logs F
