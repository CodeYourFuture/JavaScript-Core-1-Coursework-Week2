 ...
 * - There is a helper function called  'getAvailableStations' that takes an integer as an argument and returns a boolean.
...
function getStations(){
  ...
  return getAvailableStations(availableFrequencies);
}
