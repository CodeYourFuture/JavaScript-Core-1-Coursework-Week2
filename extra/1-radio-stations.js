...
function getStations(){
  const frequenciesAvalaible=getAllFrequencies(); 
  const TheFrenquenciesOfTheRadio=frequenciesAvalaible.filter(frequency)
  function frequency(intergerValue){
    return isRadioStation(intergerValue);
  }
  return TheFrenquenciesOfTheRadio;
}
