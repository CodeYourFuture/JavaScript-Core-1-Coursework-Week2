...
function getStations(){
  const availableFrequencies=getAllFrequencies(); // getting the available frequency from getAllFrequencies
  const radioFrequencies=availableFrequencies.filter(frequency)
  function frequency(int){
    return isRadioStation(int);// takes the value of int as argument.
  }
