...
function getStations() {
  let myStations = getAllFrequencies();
  let radioStations = [];
  for (let j = 87; j < myStations.length; j++) {
    myStations[j] = Math.floor(Math.random() * 100) + 1;
    radioStations.push(myStations[j]);
  }
