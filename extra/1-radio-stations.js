...
//ToDo: TestBug; every isRadioStation function call check different random array So sometimes failed
const getStations = ()=>{
  return getAllFrequencies().filter((value) => isRadioStation(value) === true);
}
