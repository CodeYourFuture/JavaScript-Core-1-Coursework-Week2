/*
  ...
  1. This program throws an error. Why? (If you can't find it, try executing it). b is not a Global Variable, that`s why we have error
  2. Remove the line that throws the error.
  3. What is printed to the console? 2 and then 6, 4, 9, 6, 13, 8      
