/*
  ...
  1. This program throws an error. Why? (If you can't find it, try executing it). There is an error because b has not been assigned a variable
...
for (let i = 0; i < 5; ++i) {
  a = a + 1; // a = 7, a= 8, a = 9, a= 10. a = 11
  if (i % 2 === 0) {
    const d = f2(i, x);
    console.log(d); // this is called 3 times 0, 2, 4
  } else {
    const e = f1(i, a);
    console.log(e); // this is called 2 times 1, 3
  }
}
