/*
  ...
  1. This program throws an error. Why? (If you can't find it, try executing it). b is not assigned to value value  
  2. Remove the line that throws the error.// error in line 30 removed
