...
function tidyUpString(strArr) {
  ...
  for(let i = 0; i < strArr.length; i++){
    removeSpace = strArr[i].trim();//remove space
    removeSlash = removeSpace.replace("/", "");//removes slashes
    toLowerCase = removeSlash.toLowerCase();// makes letters in string lowercase
