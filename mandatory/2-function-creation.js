...
function tidyUpStrings(arrayOfStrings) {
  ...
  // let newArray = [];
  // let replaceSlashes = replaceSlashes;
  // let removeSpacesStart = replaceSlashes.trimStart();
  // let removeSpacesEnd = removeSpacesStart.trimEnd();
  // return removeSpacesEnd.toLowerCase();
}
