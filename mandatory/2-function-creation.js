...
function tidyUpStrings(arrayOfStrings) {
  let noWhiteSpacesString = arrayOfStrings.trim();
  let noForwardSlashesString = noWhiteSpacesString.replace("/", ""));
  let lowerCaseString = noForwardSlashesString.toLoweCase();
