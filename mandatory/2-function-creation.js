/*
  ...
  To be acceptable, two conditions must be fulfilled
    ...
    npm test -- --testPathPattern mandatory/2-function-creation.js
*/
function isAcceptableUser(userAge, isLoggedIn) {
  let userOld=18;
if (userAge>=userOld&&isLoggedIn){
  return true;
 }
 else {
  return false;
...
function applyDiscount(totalPrice) {
  let finalPrice10=totalPrice-(totalPrice/100)*10;
  let finalPrice5=totalPrice-(totalPrice/100)*5;
