...
function tidyUpStrings(arrayOfStrings) {
  // let removeSpace = arrayOfStrings.trim();
  // let replaceSlash = removeSpace.replace("/");
  // let lowercase = replaceSlash.toLowerCase();
  // using Map Function
  let String = arrayOfStrings.map((x) => x.trim().replace("/").toLowerCase());
  return String;
}
